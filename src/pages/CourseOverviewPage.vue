<template>
    ...
    <div class="bg-accent flex flex-col items-center py-20 md:flex-row md:justify-around md:pt-10">
        ...
        <CustomRouterLink to="/course/:courseId">
            <div class="relative">
                ...
                <div class="absolute bottom-10 left-10">
                    ...
                    <h3 class="text-h3 text-white mt-5">Spaghetti maken</h3>
                </div>
            </div>
        </CustomRouterLink>
    </div>
